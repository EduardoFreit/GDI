...
BEGIN
        IF INSERTING THEN
            RAISE_APPLICATION_ERROR(-2010, 'Proibido inserir cursos de Licenciatura');
        ELSIF UPDATING THEN
            RAISE_APPLICATION_ERROR(-2011, 'Proibido atualizar cursos de Licenciatura');
        ELSIF DELETING THEN
            RAISE_APPLICATION_ERROR(-2012, 'Proibido deletar cursos de Licenciatura');
        END IF;
END Impedir_Lic;
/
